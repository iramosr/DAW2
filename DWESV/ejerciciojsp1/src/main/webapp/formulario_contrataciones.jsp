...
<%@ page import="com.daw2.ejerciciojsp1.dao.impl.ViajesDaoImpl" %>
<%@ page import="com.daw2.ejerciciojsp1.dao.ViajesDao" %>
<%@ page import="com.daw2.ejerciciojsp1.dao.impl.ClientesDaoImpl" %>
<%@ page import="com.daw2.ejerciciojsp1.dao.ClientesDao" %>
