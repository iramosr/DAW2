...
class EncuestasDao extends Dao
{
    ...
    {
        return "id, nombre, apellidos, email, fecha_nacimiento, sexo, aficiones, estudios, observaciones, foto, created_at, updated_at";
    }

    protected function _add($data): object
    {
        $createdAt = $updatedAt = date("Y-m-d H:i:s");
        $sql = 'INSERT INTO ' . $this->tableName() . '(' . $this->itemsTable() . ')' . 'VALUES(null, :nombre, :apellidos, :email, :fecha_nacimiento, :sexo, :aficiones, :estudios, :observaciones, :foto, :createdAt, :updatedAt)';
