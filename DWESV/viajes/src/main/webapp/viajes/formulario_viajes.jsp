...
<%
    ...
    String plazas = viaje.getPlazas() != null ? String.valueOf(viaje.getPlazas()) : "";
    String salida = viaje.getSalida() != null ? new SimpleDateFormat("yyyy-MM-dd'T'HH:mm").format(viaje.getSalida()) : "";
    String llegada = viaje.getLlegada() != null ? new SimpleDateFormat("yyyy-MM-dd'T'HH:mm").format(viaje.getLlegada()) : "";
            ...
            <div class="row mb-3">
                ...
                <div class="col-12 col-md-3 form-floating">
                    <input type="number" step="1" class="form-control" id="plazas" name="plazas"
                           placeholder="Introduce las plazas" value="<%=plazas%>"<%=readonly%> <%=required%>>
