            ...
            <div class="card-body bg-light-subtle">
                <div class="row mb-3">
                    <div class="col-12 col-md-4 form-floating">
                        <select class="form-select" id="viajeId" name="viajeId" <%=disabled%> <%=required%>>
                            ...
                            <option  id="option" value="<%=viaje.getId()%>" codigo="<%=viaje.getCodigo()%>" <%if (Objects.equals(viajeId, viaje.getId().toString())) { %>
                                    selected
                                    <% } %>>
                                <%=viaje.getTitulo()%>
                            </option>
                        ...
                        <label for="viajeId">Selecciona un viaje</label>

                        <input type="hidden" name="viajeId" value="<%=viajeId%>"/>
                    </div>

                    <div class="col-12 col-md-4 form-floating">
                        <select class="form-select" id="clienteId" name="clienteId" <%=disabled%> <%=required%>>
                    ...
                    <div class="col-12 col-md-4 form-floating">
                        <input type="pagado" class="form-control" id="pagado" name="pagado"
                               ...
                               value="<%=pagado%>"<%=readonly%> <%=required%>>
